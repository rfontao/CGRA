class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.water_texture_height = new CGFtexture(this, "textures/waterMap.jpg");
		this.water_appearance = new CGFappearance(this);
		this.water_appearance.setAmbient(0.3, 0.3, 0.3, 1);
		this.water_appearance.setDiffuse(0.7, 0.7, 0.7, 1);
		this.water_appearance.setSpecular(0.0, 0.0, 0.0, 1);
		this.water_appearance.setShininess(120);
		this.water_appearance.setTexture(this.water_texture);
	...
	display() {
		...
		if (this.selectedObject==0) {
			...
			this.water_texture_height.bind(2);
			var short = this.water_texture_height.gl;
